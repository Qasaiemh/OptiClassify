...
class OTO extends StatefulWidget {
  static String routeName = '/OTO';
  const OTO({super.key});

  @override
  State<OTO> createState() => _OTOState();
}
...
class _OTOState extends State<OTO> {
...
///////////////////////////////////////////////////////////////////////////
  void _analyzeImage(File image) {
    ...
    if (plantLabel == 'Correct') {
      //move to ProcessCompletePage
      print('compleeeeeeeeeeeeeeeeeeeeet');
      correctLabelCount++;
    }
  }
