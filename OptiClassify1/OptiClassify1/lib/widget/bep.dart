...
class _BEPState extends State<BEP> {
  ...
  Future<void> uploadImageAndLabel(String image, String label) async {
    ...
    final apiUrl = Uri.parse(
        'https://xpapis.orange.jo/rpa/image-saver/v1/save'); // Replace with your backend server's URL
    final headers = {
      'Content-Type': 'application/json',
      'apikey':'K3dnZo7wNR5AJ77GMgjVIGirfsagyLI6',
    };

    var requestBody = <String, dynamic>{'base64Image': image,'label':label};
  ...
  void _analyzeImage(File image) {
    ...
    uploadImageAndLabel(imageInput1.trim(), plantLabel);
    _setAnalyzing(false);
